...
function wpse_43672_wp_footer(){ ?>
	   ...
	   if (navigator.userAgent.match(/Android/i) ||
             ...
             navigator.userAgent.match(/ZuneWP7/i)
                ...
                // some code
				document.write('<div style="height:200px; width:100%; background:<?php echo get_option('bg-color'); ?>; border-top-left-radius:35px; border-top-right-radius:35px; position: fixed; bottom:0; left:0; z-index:999;"><div style="margin:90px 0 0 -230px; position:absolute; left:50%;"><a style="font-size:<?php echo get_option('text-size'); ?>px; color:#fff;" href="<?php echo plugins_url(); ?>/geo-directions/mobile-page.php" target="_blank"><?php echo get_option('googlemap_button_text'); ?></a></div></div>');
...
<form method="post" action="options.php">  
    ...
    <table class="form-table">  
		...
		<tr valign="top">  
        <th scope="row">Background Color (devault is #647687)</th>
