...
<html lang="en">
   <head>
		...
		<link rel="stylesheet" href="<?php echo plugins_url(); ?>/geo-directions/css/style.css" type="text/css" media="screen" />
	<?php
	function mda_script_init() {
    wp_register_script( 'jquerycustom', plugins_url() .'/geo-directions/js/custom.js', array( 'jquery' ), '1.0' );
    wp_enqueue_script( 'jquerycustom' );
	wp_register_script( 'jquerypremobile', plugins_url() .'/geo-directions/js/mobile.js', array( 'jquery' ), '1.0' );
    wp_enqueue_script( 'jquerypremobile' );
	wp_register_script( 'googlemaps', plugins_url() .'/geo-directions/js/googlemaps.js', array( 'jquery' ), '1.0' );
